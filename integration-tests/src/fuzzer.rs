...
pub struct Fuzzed {
    // message fields
    pub builtin_addrs: ::protobuf::RepeatedField<::std::string::String>,
    pub genesis_account: ::protobuf::SingularPtrField<EOA>,
...
impl Fuzzed {
    ...
    pub fn get_genesis_account(&self) -> &EOA {
        self.genesis_account.as_ref().unwrap_or_else(|| <EOA as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for Fuzzed {
    ...
    fn default_instance() -> &'static Fuzzed {
        static instance: ::protobuf::rt::LazyV2<Fuzzed> = ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for EOA {
    ...
    fn default_instance() -> &'static EOA {
        static instance: ::protobuf::rt::LazyV2<EOA> = ::protobuf::rt::LazyV2::INIT;
...
pub struct FuzzResult {
    // message fields
    pub roots: ::protobuf::RepeatedField<::std::string::String>,
    pub dumps: ::protobuf::RepeatedField<::std::string::String>,
    pub traces: ::protobuf::RepeatedField<::std::string::String>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl ::protobuf::Message for FuzzResult {
    ...
    fn default_instance() -> &'static FuzzResult {
        static instance: ::protobuf::rt::LazyV2<FuzzResult> = ::protobuf::rt::LazyV2::INIT;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0cfuzzer.proto\"m\n\x06Fuzzed\x12\x15\n\rbuiltin_addrs\x18\x01\x20\
    \x03(\t\x12\x1d\n\x0fgenesis_account\x18\x02\x20\x02(\x0b2\x04.EOA\x12\
    \x16\n\x06blocks\x18\x03\x20\x03(\x0b2\x06.Block\x12\x15\n\ris_debug_mod\
    e\x18\x04\x20\x02(\x08\"\x85\x01\n\x05Block\x12\x0e\n\x06number\x18\x01\
    \x20\x02(\x04\x12\x0e\n\x06author\x18\x02\x20\x02(\t\x12\x11\n\ttimestam\
    p\x18\x03\x20\x02(\x04\x12\x12\n\ndifficulty\x18\x04\x20\x02(\x04\x12\
    \x11\n\tgas_limit\x18\x05\x20\x02(\x04\x12\"\n\x0ctransactions\x18\x06\
    \x20\x03(\x0b2\x0c.Transaction\"\xc3\x02\n\x0bTransaction\x12\x0e\n\x06s\
    ender\x18\x01\x20\x02(\t\x12\x10\n\x08receiver\x18\x02\x20\x01(\r\x12\
    \x16\n\x0ereceiver_debug\x18\x03\x20\x01(\t\x12\x11\n\tgas_price\x18\x04\
    \x20\x02(\x04\x12\x0b\n\x03gas\x18\x05\x20\x02(\x04\x12\r\n\x05value\x18\
    \x06\x20\x02(\x04\x12\x14\n\x0cis_create_tx\x18\n\x20\x02(\x08\x12\x14\n\
    \x0ccall_tx_data\x18\x0b\x20\x01(\x0c\x12\x1d\n\x15create_tx_constructor\
    \x18\x0c\x20\x01(\x0c\x12\x1a\n\x12create_tx_contract\x18\r\x20\x01(\x0c\
    \x12%\n\x1dcreate_tx_constructor_postfix\x18\x0e\x20\x01(\x0c\x12\"\n\
    \x1acreate_tx_contract_postfix\x18\x0f\x20\x01(\x0c\x12\x19\n\x11tx_data\
    _hex_debug\x18\x10\x20\x01(\t\"6\n\x03EOA\x12\x0f\n\x07address\x18\x01\
    \x20\x02(\t\x12\x0f\n\x07balance\x18\x02\x20\x02(\x04\x12\r\n\x05nonce\
    \x18\x03\x20\x02(\x04\":\n\nFuzzResult\x12\r\n\x05roots\x18\x01\x20\x03(\
    \t\x12\r\n\x05dumps\x18\x02\x20\x03(\t\x12\x0e\n\x06traces\x18\x03\x20\
    \x03(\t\
";
