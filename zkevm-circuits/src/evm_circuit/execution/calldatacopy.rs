...
mod test {
    ...
    use crate::test_util::{run_test_circuits, test_circuits_using_bytecode, BytecodeTestConfig};
    use eth_types::{
        bytecode,
    ...
    fn test_ok_internal(
        _call_data_offset: Word,
        _call_data_length: Word,
        memory_offset: Word,
        data_offset: Word,
        length: Word,
    ) {
        ...
        let mut test_config = BytecodeTestConfig::default();
        test_config.is_root_call = false;
